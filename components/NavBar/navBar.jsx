...
const NavBarMobile = () => {
    return(
        <div className="w-60 bg-red-800 sticky bottom-5 h-12 rounded-md border border-neutral-800 place-self-center flex flex-row flex-nowrap place-items-center shadow-md shadow-black">
